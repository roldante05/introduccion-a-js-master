...
// - Crear una funcion que tome como parametro el año actual y el añlo de nacimiento y calcule la edad del usuario (mas o menos).
// - Preguntarle estos datos al usuario y guardarlos en 2 variables
// - Ejecutar la funcion con estos datos
// - Impriman el resultado en la consola

// function calcularEdadUsuario(anioActual, anioDeNacimiento) {
//     return anioActual - anioDeNacimiento
// }
// let anioActual = Number(prompt("Cual es el año actual?","2022"));
// let anioDeNacimiento = Number(prompt("Cual es el año de tu nacimiento?"));

// let calcularEdad = calcularEdadUsuario(anioActual, anioDeNacimiento);
...
// Lo mismo con diario semanal, por hora.

// let salarioMensual = Number(prompt("Cual es tu salario mensual? "));
// // let salario_Diario = salario_Mensual
// function calcularSalarioAnualUsuario(salarioMensual) {
//     const MESES_EN_UN_ANIO = 12
//     return salarioMensual * MESES_EN_UN_ANIO;
// }
// console.log('Tu salario anual es de ' + calcularSalarioAnualUsuario(salarioMensual));

// function calcularSalarioDiario(salarioDiario) {
//     const DIAS_POR_ANIO = 365
//     return salarioDiario / DIAS_POR_ANIO;
// }
...
// const operador = prompt("ingrese '+' para sumar / Ingrese '-' para restar");
...
// if (operador === '+') {
//     console.log("El resultado de tu suma es " + calcularSuma(num1, num2));
// } else {
//     console.log("El resultado de tu resta es " +calcularResta(num1, num2));
// }
...
//     console.log("El resultado de tu resta es " + calcularResta(num1, num2));
// } else if (operador ==='*') {
//     console.log("El resultado de tu multiplicacion es " + calcularMultiplicacion(num1, num2));
// } else if (operador ==='/'){
//     console.log("El resultado de tu division es " + calcularDivision(num1, num2));
// } else {
...
//   console.log("Hola, Dante! Yo tambien me llamo Dante");
// } else if (nombreUsuario === "ignacio") {
//   console.log("Hola, Ignacio! te llamas igual que mi hermano");
// } else {
...
//Tarea 2:
// const edadDelUsuario = Number(prompt("Cual es tu edad?"));
// const miEdad = 20;
...
// //Tarea 3:
// const usuarioDocumento = prompt("Tienes documento?")'.toLowerCase()';
...
//     }
//     else {
//       console.log("No podes pasar al bar, sos menor de edad");
//     }
// }
// else if(usuarioDocumento === 'no'){
//     console.log("Perdon, pero sin documento no podes entrar al bar");
// }
// else {
