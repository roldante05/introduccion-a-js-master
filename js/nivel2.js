...
// const comidasFavoritas = ["milanesa","fideo a la bolognesa","picada de fiambre"]
...
// const animales = ['conejo', 'pajaro','carpincho'];
...
// const comidas = ['pizza','fideos','asado'];

// for (let i = 0 ; i < comidas.length; i++){
//     console.log('Me gusta ' + comidas[i]);
// }
...
// let notaUno = Number(prompt("Dame la primer nota"));
// let notaDos = Number(prompt("Dame la segunda nota"));
// let notaTres = Number(prompt("Dame la tercera nota"));
// let notaCuatro = Number(prompt("Dame la cuarta nota"));

// const arrayDeNumeros = [notaUno, notaDos, notaTres, notaCuatro];

// function calcularPromedio(arrayDeNumeros) {
//   let totalPromedio = 0;

//   for (i = 0; i < arrayDeNumeros.length; i++) {
//     totalPromedio = totalPromedio + arrayDeNumeros[i];
//   }

//   return totalPromedio / arrayDeNumeros.length;
// }
// console.log(calcularPromedio(arrayDeNumeros));
